...
public class InvokeHelper {
    ...
    public static String POST_K3CloudURL = "http://yeelight.ik3cloud.com/K3cloud/";
    ...
    static {
        ...
        map.put("UnEffective",
                "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.UnEffective.common.kdsvc");
    }
    ...
    // UnEffective
    public static String UnEffective(String formId, String content) throws Exception {
        Invoke("UnEffective", formId, content);
        return formId;
    }
    ...
    // ExecuteBillQuery
    public static String ExecuteBillQuery(String formId, String content) throws Exception {
    ...
    private static String Invoke(String deal, String formId, String content)
        ...
        System.out.println("金蝶返回内容："+stringBuffer.toString());
